...
const data = [
  ...
  // },
  {
    ...
    desc: [
      ...
      "Klassik Gödəkçələr",
      "Alt paltar",
      "Kəmər,Eynək və Saatlar",
      "Baş Geyimləri",
      "Əlcək və Şərflər",
      "Qalstuk və Kəpənəklər",
      "Səndəl",
  ...
  },
  {
    id: 4,
    titles: "Qadın",
    desc: ["Gödəkçə", "Cins şalvar", "Kostyum","İdman ayaqqabıları","Klassik ayaqqabılar","Parça şalvarlar","Çantalar","İdman dəstləri","Daxili geyimlər","Ətəklər və Şortlar","Palto","Klassik köynəklər","Futbolka və Polo","Bluzlar","Bodi","Kalqotka və Corab","Donlar","Topuqlu ayaqqabılar","Səndəllər","Ev geyimləri","Gəlinlik","Papaq və Hicablar"],
    images: [
  ...
  {
    id: 5,
    titles: "Qız Uşaq Geyimləri",
    desc: ["Cins", "Bluz və Köynək","Gödəkcə","Don", "İdman Geyiməri","Pencək və Kostyumlar","Alt paltar və Çimərlik","Futbolka və Polo","Ətək və Şortlar","Kalqotka və Corablar","Papaq","Əlcək","Sport ayaqqabı","Klassik ayaqqabı","Botlar","Səndəl",],
    images: [
  ...
  {
    id: 6,
    titles: "Oğlan Uşaq Geyimləri",
    desc: ["Cinslər", "Alt paltar və ev geyimləri","Şalvar və Kombinizon", "Gödəkçələr","Köynək və Polo", "Pencək və Kostyum","Sport dəstlər", "Papaq","Əlcək", "Corab və Kalqotka",],
    images: [
...
const SearchScreen = () => {
  ...
  useEffect(() => {
    // Find the "Kişi" item in the data array
    const kisiItem = data.find(item => item.titles === "Kişi");
    if (kisiItem) {
      setSelectedItem(kisiItem);
    }
  }, []);
  ...
  const goToProductDetails = (item, index) => {
    ...
    const description = selectedItem.desc[index];
...
const styles = StyleSheet.create({
  ...
  selectedItem: {
    backgroundColor: "#cce5ff", // Seçili öğe için farklı arka plan rengi
    borderColor: "#004085",
  },
});
